...
本项目建立的最大初衷就是希望能为后来者提供更加具有参考价值的东西，人工智能专业的建立可以说学校也是煞费苦心，提供了众多可以训练我们能力的实验。我们深知，没有经过这些磨练，自己不可能得到成长，因此本开源库的唯一不可打破的底线就是上传具有唯一性、或者为统一指定任务的课程作业（即直接爬下来就可以交作业），以下类别将不会出现本次及以后系列的内容中：
